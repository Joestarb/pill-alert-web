...
export default function NotificationDropdown() {
  ...
  return (
    <div className="relative">
      <button
        className=" dark:bg-(--color-dark-bg)  relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200   rounded-full dropdown-toggle hover:text-gray-700 h-11 w-11 hover:bg-gray-100"
        onClick={handleClick}
      >
        <span
        ...
        className="dark:text-[#8EC5FF]  w-4 h-6 transition-transform duration-300 hover:rotate-45"
